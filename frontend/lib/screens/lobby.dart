...
class _LobbyScreenState extends State<LobbyScreen> {
  String roomCode = "...";
  List<String> players = [];
  String _selectedGame = "Mosaic"; // Default Game Card
      ...
      body: SafeArea(
        child: Column(
          children: [
                ...
                children: [
                  ...
                  PhysicsButton(
                    ...
                    customChild: Row(
                      ...
                      children: [
                        Text("Code: $roomCode", style: const TextStyle(color: tInk, fontWeight: FontWeight.bold, fontSize: 14)),
                        const SizedBox(width: 8),
                        const Icon(Icons.ios_share, color: tInk, size: 16),
                      ],
                    ),
                  )
                ],
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: isMe ? tTeal : Colors.transparent, width: 3),
            ...
            // ZONE 3: THE ACTION DOCK (flex: none)
            Container(
                      ...
                      return Expanded(
                        child: GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: tSurface, borderRadius: BorderRadius.circular(12),
                              border: Border.all(color: isSelected ? tTeal : Colors.transparent, width: 2),
                              boxShadow: isSelected ? [BoxShadow(color: tTeal.withOpacity(0.2), blurRadius: 8, offset: const Offset(0, 4))] : [],
                            ),
