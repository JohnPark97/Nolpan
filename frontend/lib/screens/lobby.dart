...
class _LobbyScreenState extends State<LobbyScreen> {
  ...
  void initState() {
    ...
    // THE FIX: Pull code directly from socket service backup
      ...
      body: SafeArea(
        child: Column(children: [
          Padding(padding: const EdgeInsets.all(24), child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            // THE FIX: Updated Pill with Share Icon
            PhysicsButton(
              text: "", color: tSurface, shadowColor: Colors.grey[300]!, isFullWidth: false,
              onTap: () { ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Room code copied to clipboard!"))); },
              customChild: Row(
